...
export const actions = {
  hostCreate: (id: string, config: HostConfig): Action => ({
    type: types.HOST_CREATE,
    id,
    config,
  }),
  hostEdit: (id: string, config: HostConfig): Action => ({
    type: types.HOST_EDIT,
    id,
    config,
  }),
  ...
  hostStateConnected: (id: string, time: Date): Action => ({
    type: types.HOST_STATE_CHANGE,
    id,
    status: 'connected',
    time,
  }),
  hostStateDisconnecting: (id: string, reason: string): Action => ({
    type: types.HOST_STATE_CHANGE,
    id,
    status: 'disconnecting',
    reason,
  }),
  hostStateDisconnected: (id: string): Action => ({
    type: types.HOST_STATE_CHANGE,
    id,
    status: 'disconnected',
  }),
  hostStateError: (id: string): Action => ({
    type: types.HOST_STATE_CHANGE,
    id,
    status: 'error',
  }),
