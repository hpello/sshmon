...
export const actions = {
  autoforwardCreate: (
    ...
    fwdId: string,
    config: AutoforwardConfig
  ): Action => ({ type: types.AUTOFORWARD_CREATE, id, fwdId, config }),
  autoforwardEdit: (
    id: string,
    fwdId: string,
    config: AutoforwardConfig
  ): Action => ({ type: types.AUTOFORWARD_EDIT, id, fwdId, config }),
  autoforwardDelete: (id: string, fwdId: string): Action => ({
    type: types.AUTOFORWARD_DELETE,
    id,
    fwdId,
  }),
  ...
  autoforwardCancel: (id: string, fwdId: string): Action => ({
    type: types.AUTOFORWARD_CANCEL,
    id,
    fwdId,
  }),
